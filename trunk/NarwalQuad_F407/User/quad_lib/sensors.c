...
static MARG_SENSOR_TypeDef * MARG_SENSORS[SENSORn] = { &Magnetometer, &Acclermeter, &Gyroscope };
...
void SensorIRQ_Complete()
{
	//if(CurrentSensor > 0);
	MARG_SENSORS[CurrentSensor]->SensorValueUpdated = 1;
	CurrentSensor = -1;
